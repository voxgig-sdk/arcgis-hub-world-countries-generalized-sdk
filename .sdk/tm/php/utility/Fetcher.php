...
// ArcgisHubWorldCountriesGeneralized SDK utility: fetcher

class ArcgisHubWorldCountriesGeneralizedFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; ArcgisHubWorldCountriesGeneralizedSDK/1.0)';
    ...
    public static function call(ArcgisHubWorldCountriesGeneralizedContext $ctx, string $fullurl, array $fetchdef): array
    {
