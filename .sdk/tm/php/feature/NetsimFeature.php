...
// ArcgisHubWorldCountriesGeneralized SDK netsim feature
...
class ArcgisHubWorldCountriesGeneralizedNetsimFeature extends ArcgisHubWorldCountriesGeneralizedBaseFeature
{
    ...
    private function _simulate(ArcgisHubWorldCountriesGeneralizedContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(ArcgisHubWorldCountriesGeneralizedContext $ctx, array $applied): void
    {
        $client = $this->client;
