...
// ArcgisHubWorldCountriesGeneralized SDK feature test
//
...
class FtCtrl extends ArcgisHubWorldCountriesGeneralizedControl
{
...
class FtClient
{
    ...
    private ArcgisHubWorldCountriesGeneralizedUtility $utility;

    public function __construct(ArcgisHubWorldCountriesGeneralizedUtility $utility, array $options)
    {
    ...
    public function get_utility(): ArcgisHubWorldCountriesGeneralizedUtility
    {
        return $this->utility;
    }
}
...
class FtRecorder
{
    ...
    {
        return function (ArcgisHubWorldCountriesGeneralizedContext $_ctx, string $url, array $fetchdef): array {
...
class FtHarness
{
    ...
    public ArcgisHubWorldCountriesGeneralizedContext $rootctx;

    // True when this SDK was generated with the named feature.
    public static function hasFeature(string $name): bool
    {
        if (self::$feature_config === null) {
            $config = ArcgisHubWorldCountriesGeneralizedConfig::make_config();
            $f = $config['feature'] ?? [];
    ...
    public function __construct(
        ...
        $utility = new ArcgisHubWorldCountriesGeneralizedUtility();
        $this->utility = $utility;

        $utility->fetcher = $server ?? function (ArcgisHubWorldCountriesGeneralizedContext $_ctx, string $_url, array $fetchdef): array {
        ...
        foreach ($features as $fspec) {
            ...
            $f = ArcgisHubWorldCountriesGeneralizedConfig::make_feature($name);
    ...
    private static function buildUrl(ArcgisHubWorldCountriesGeneralizedSpec $spec): string
    {
        $keys = [];
    ...
    public function op(array $o = []): array
    {
        ...
        if (($ctx->out['point'] ?? null) instanceof ArcgisHubWorldCountriesGeneralizedError) {
        ...
        if (is_array($fetched)) {
            $ctx->response = new ArcgisHubWorldCountriesGeneralizedResponse($fetched);
        }
    ...
    private function fail(ArcgisHubWorldCountriesGeneralizedContext $ctx, mixed $err): array
    {
...
class FeatureTest extends TestCase
{
    ...
    public function test_retry_retries_a_transport_error_until_exhausted(): void
    {
        ...
        $clock = new FtClock();
        $n = 0;
        $server = function (ArcgisHubWorldCountriesGeneralizedContext $ctx, string $_url, array $_fd) use (&$n): array {
            $n++;
