...
class ArcgisHubWorldCountriesGeneralizedContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = ArcgisHubWorldCountriesGeneralizedControl()
        ...
        if isinstance(sp, ArcgisHubWorldCountriesGeneralizedSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, ArcgisHubWorldCountriesGeneralizedResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, ArcgisHubWorldCountriesGeneralizedResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return ArcgisHubWorldCountriesGeneralizedOperation({})
    ...
    def make_error(self, code, msg):
        return ArcgisHubWorldCountriesGeneralizedError(code, msg, self)
