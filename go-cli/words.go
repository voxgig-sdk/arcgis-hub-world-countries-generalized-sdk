...
func registerSDKWords(r *eng.Registry, client *sdk.ArcgisHubWorldCountriesGeneralizedSDK) {
...
func runOp(client *sdk.ArcgisHubWorldCountriesGeneralizedSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
