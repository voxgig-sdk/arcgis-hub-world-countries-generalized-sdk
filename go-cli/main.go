// Command ArcgisHubWorldCountriesGeneralized-cli is a CLI + REPL for the ArcgisHubWorldCountriesGeneralized SDK,
...
const prompt = "arcgis-hub-world-countries-generalized"

// entitiesHelp is the space-separated entity list shown by /help.
const entitiesHelp = "feature metadata"
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      ARCGIS_HUB_WORLD_COUNTRIES_GENERALIZED_APIKEY (api key), ARCGIS_HUB_WORLD_COUNTRIES_GENERALIZED_BASE (base url override)")
