...
The PHP SDK for the ArcgisHubWorldCountriesGeneralized API. Provides an entity-oriented interface using PHP conventions.
...
```php
[$result, $err] = $client->Feature(null)->list(null, null);
...
[$result, $err] = $client->ArcgisHubWorldCountriesGeneralized(null)->load(
    ["id" => "test01"], null
);
