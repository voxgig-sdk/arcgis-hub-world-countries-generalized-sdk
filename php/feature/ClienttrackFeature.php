...
// ArcgisHubWorldCountriesGeneralized SDK clienttrack feature
...
class ArcgisHubWorldCountriesGeneralizedClienttrackFeature extends ArcgisHubWorldCountriesGeneralizedBaseFeature
{
    ...
    public function PostConstruct(ArcgisHubWorldCountriesGeneralizedContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'ArcgisHubWorldCountriesGeneralized-SDK';
