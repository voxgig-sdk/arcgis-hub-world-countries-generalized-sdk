...
// ArcgisHubWorldCountriesGeneralized SDK ratelimit feature
...
class ArcgisHubWorldCountriesGeneralizedRatelimitFeature extends ArcgisHubWorldCountriesGeneralizedBaseFeature
{
    ...
    private function _acquire(ArcgisHubWorldCountriesGeneralizedContext $ctx): void
    {
    ...
    private function _track(ArcgisHubWorldCountriesGeneralizedContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
