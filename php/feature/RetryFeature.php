...
// ArcgisHubWorldCountriesGeneralized SDK retry feature
...
class ArcgisHubWorldCountriesGeneralizedRetryFeature extends ArcgisHubWorldCountriesGeneralizedBaseFeature
{
    ...
    public function init(ArcgisHubWorldCountriesGeneralizedContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (ArcgisHubWorldCountriesGeneralizedContext $ctx2, string $url, array $fetchdef) use ($inner): array {
            return $this->_with_retry($ctx2, $url, $fetchdef, $inner);
        };
    }

    private function _with_retry(ArcgisHubWorldCountriesGeneralizedContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
    ...
    private function _track(ArcgisHubWorldCountriesGeneralizedContext $_ctx, int $attempt, mixed $res, mixed $err, float $wait): void
    {
        $client = $this->client;
