...
// ArcgisHubWorldCountriesGeneralized SDK rbac feature
...
class ArcgisHubWorldCountriesGeneralizedRbacFeature extends ArcgisHubWorldCountriesGeneralizedBaseFeature
{
    ...
    private function _required(ArcgisHubWorldCountriesGeneralizedContext $ctx): ?string
    {
    ...
    private function _reject(ArcgisHubWorldCountriesGeneralizedContext $ctx, string $required): void
    {
    ...
    private function _track(ArcgisHubWorldCountriesGeneralizedContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
