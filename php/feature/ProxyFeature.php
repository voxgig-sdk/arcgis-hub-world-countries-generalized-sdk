...
// ArcgisHubWorldCountriesGeneralized SDK proxy feature
...
class ArcgisHubWorldCountriesGeneralizedProxyFeature extends ArcgisHubWorldCountriesGeneralizedBaseFeature
{
    ...
    public function init(ArcgisHubWorldCountriesGeneralizedContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (ArcgisHubWorldCountriesGeneralizedContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
