...
// ArcgisHubWorldCountriesGeneralized SDK timeout feature
...
class ArcgisHubWorldCountriesGeneralizedTimeoutFeature extends ArcgisHubWorldCountriesGeneralizedBaseFeature
{
    ...
    private function _with_timeout(ArcgisHubWorldCountriesGeneralizedContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(ArcgisHubWorldCountriesGeneralizedContext $_ctx, float $ms): void
    {
        $client = $this->client;
