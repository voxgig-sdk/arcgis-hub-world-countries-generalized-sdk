...
// ArcgisHubWorldCountriesGeneralized SDK utility type

class ArcgisHubWorldCountriesGeneralizedUtility
{
    ...
    public static function copy(ArcgisHubWorldCountriesGeneralizedUtility $src): ArcgisHubWorldCountriesGeneralizedUtility
    {
        $u = new ArcgisHubWorldCountriesGeneralizedUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
