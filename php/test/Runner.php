...
class ArcgisHubWorldCountriesGeneralizedTestRunner
{
    ...
    {
        $live = self::getenv('ARCGISHUBWORLDCOUNTRIESGENERALIZED_TEST_LIVE');
        $override = self::getenv('ARCGISHUBWORLDCOUNTRIESGENERALIZED_TEST_OVERRIDE');
        ...
        $explain = self::getenv('ARCGISHUBWORLDCOUNTRIESGENERALIZED_TEST_EXPLAIN');
...
class_alias('ArcgisHubWorldCountriesGeneralizedTestRunner', 'Runner');
class_alias('ArcgisHubWorldCountriesGeneralizedHelpers', 'Helpers');
