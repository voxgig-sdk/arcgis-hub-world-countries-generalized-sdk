...
// ArcgisHubWorldCountriesGeneralized SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (ArcgisHubWorldCountriesGeneralizedSDK::test)
...
{
    private const SDK_CLASS = 'ArcgisHubWorldCountriesGeneralizedSDK';
    ...
    private const SDK_BASE = 'arcgishubworldcountriesgeneralized_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../arcgishubworldcountriesgeneralized_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
