...
class FeatureDirectTest extends TestCase
{
    public function test_direct_list_feature(): void
    {
        $setup = feature_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-feature", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
