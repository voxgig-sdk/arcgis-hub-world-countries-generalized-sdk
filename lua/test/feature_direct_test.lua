...
describe("FeatureDirect", function()
  it("should direct-list-feature", function()
    local setup = feature_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-feature", setup.live and "live" or "unit")
...
function feature_direct_setup(mockres)
