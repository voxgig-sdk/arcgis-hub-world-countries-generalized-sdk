...
function runner.env_override(m)
  local live = runner.getenv("ARCGISHUBWORLDCOUNTRIESGENERALIZED_TEST_LIVE")
  local override = runner.getenv("ARCGISHUBWORLDCOUNTRIESGENERALIZED_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("ARCGISHUBWORLDCOUNTRIESGENERALIZED_TEST_EXPLAIN")
