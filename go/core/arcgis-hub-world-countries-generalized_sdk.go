...
func NewArcgisHubWorldCountriesGeneralizedSDK(options map[string]any) *ArcgisHubWorldCountriesGeneralizedSDK {
	sdk := &ArcgisHubWorldCountriesGeneralizedSDK{
		Mode:     "live",
		Features: []Feature{},
	}
...
func (sdk *ArcgisHubWorldCountriesGeneralizedSDK) OptionsMap() map[string]any {
...
func (sdk *ArcgisHubWorldCountriesGeneralizedSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *ArcgisHubWorldCountriesGeneralizedSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *ArcgisHubWorldCountriesGeneralizedSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *ArcgisHubWorldCountriesGeneralizedSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *ArcgisHubWorldCountriesGeneralizedSDK {
	...
	sdk := NewArcgisHubWorldCountriesGeneralizedSDK(sdkopts)
	sdk.Mode = "test"
