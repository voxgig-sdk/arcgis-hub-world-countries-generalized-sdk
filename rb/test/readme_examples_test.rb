...
#      offline in seeded test mode (ArcgisHubWorldCountriesGeneralizedSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "ArcgisHubWorldCountriesGeneralized_sdk.rb")
  SDK_CLASS = "ArcgisHubWorldCountriesGeneralizedSDK"
  ...
  SDK_BASE = "ArcgisHubWorldCountriesGeneralized_sdk"
