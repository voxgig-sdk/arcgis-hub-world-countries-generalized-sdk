# ArcgisHubWorldCountriesGeneralized SDK — README + REFERENCE example snippet tests.
#
...
#      (ArcgisHubWorldCountriesGeneralizedSDK.test) seeded with an in-memory fixture for every
