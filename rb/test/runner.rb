...
module ArcgisHubWorldCountriesGeneralizedTestRunner
  @env = {}
  ...
  def self.env_override(m)
    live = getenv("ARCGISHUBWORLDCOUNTRIESGENERALIZED_TEST_LIVE")
    override = getenv("ARCGISHUBWORLDCOUNTRIESGENERALIZED_TEST_OVERRIDE")
    ...
    explain = getenv("ARCGISHUBWORLDCOUNTRIESGENERALIZED_TEST_EXPLAIN")
    m["ARCGISHUBWORLDCOUNTRIESGENERALIZED_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = ArcgisHubWorldCountriesGeneralizedTestRunner
Helpers = ArcgisHubWorldCountriesGeneralizedHelpers
Vs = VoxgigStruct
