# ArcgisHubWorldCountriesGeneralized Ruby SDK Reference

Complete API reference for the ArcgisHubWorldCountriesGeneralized Ruby SDK.
...
#### `ArcgisHubWorldCountriesGeneralizedSDK.test(testopts = nil, sdkopts = nil)`
...
```ruby
results, err = client.Feature.list(nil)
```
