# ArcgisHubWorldCountriesGeneralized Python SDK



The Python SDK for the ArcgisHubWorldCountriesGeneralized API — an entity-oriented client following Pythonic conventions.

The SDK exposes the API as capitalised, semantic **Entities** — for example `client.Feature()` — each
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/arcgis-hub-world-countries-generalized-sdk/releases)) or
...
```
py/
├── arcgishubworldcountriesgeneralized_sdk.py         -- Main SDK module
