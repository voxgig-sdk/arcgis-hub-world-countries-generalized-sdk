...
from core.utility_type import ArcgisHubWorldCountriesGeneralizedUtility
...
class ArcgisHubWorldCountriesGeneralizedSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = ArcgisHubWorldCountriesGeneralizedUtility()
    ...
    def get_utility(self):
        return ArcgisHubWorldCountriesGeneralizedUtility.copy(self._utility)
    ...
    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "ArcgisHubWorldCountriesGeneralizedSDK":
        if sdkopts is None:
            sdkopts = {}
