# ArcgisHubWorldCountriesGeneralized Python SDK Reference

Complete API reference for the ArcgisHubWorldCountriesGeneralized Python SDK.
...
#### `ArcgisHubWorldCountriesGeneralizedSDK.test(testopts=None, sdkopts=None)`
