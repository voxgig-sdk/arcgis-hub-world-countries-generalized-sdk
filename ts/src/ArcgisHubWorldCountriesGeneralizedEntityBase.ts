...
// `class AdviceEntity extends ArcgisHubWorldCountriesGeneralizedEntityBase<Advice>`.
class ArcgisHubWorldCountriesGeneralizedEntityBase<D = any> {
  name = ''
  name_ = ''
  Name = ''

  _client: ArcgisHubWorldCountriesGeneralizedSDK
  _utility: Utility
  _entopts: any
