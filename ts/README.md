...
The TypeScript SDK for the ArcgisHubWorldCountriesGeneralized API. Provides a type-safe, entity-oriented interface with full async/await support.
...
```ts
const client = new ArcgisHubWorldCountriesGeneralizedSDK({ apikey: '...' })
