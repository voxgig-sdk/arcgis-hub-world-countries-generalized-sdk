...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.ARCGISHUBWORLDCOUNTRIESGENERALIZED_TEST_LIVE ||
    'TRUE' === process.env.ARCGISHUBWORLDCOUNTRIESGENERALIZED_TEST_OVERRIDE
  ) {
  ...
  m.ARCGISHUBWORLDCOUNTRIESGENERALIZED_TEST_EXPLAIN = process.env.ARCGISHUBWORLDCOUNTRIESGENERALIZED_TEST_EXPLAIN || m.ARCGISHUBWORLDCOUNTRIESGENERALIZED_TEST_EXPLAIN
