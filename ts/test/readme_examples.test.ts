...
//     (\`new ArcgisHubWorldCountriesGeneralizedSDK(...)\` / \`ArcgisHubWorldCountriesGeneralizedSDK.test(...)\` become
//     \`ArcgisHubWorldCountriesGeneralizedSDK.test({ entity: ... })\`), transpiled to JS, and run
...
const SDK_NAME = 'ArcgisHubWorldCountriesGeneralizedSDK'
...
const TEST_SEED = {"entity":{"feature":{"test01":{"id":"test01"}},"metadata":{"test01":{"id":"test01"}}}}
...
// rewrite real client construction (\`new ArcgisHubWorldCountriesGeneralizedSDK(...)\` and any
// \`ArcgisHubWorldCountriesGeneralizedSDK.test(...)\`) to a seeded test-mode client, and give
...
function rewriteForRun(code: string): string {
  ...
  out = out.replace(/new\s+ArcgisHubWorldCountriesGeneralizedSDK\s*\([^)]*\)/g, () => SEEDED_CTOR)
  out = out.replace(/ArcgisHubWorldCountriesGeneralizedSDK\.test\s*\([^)]*\)/g, () => SEEDED_CTOR)
