# ArcgisHubWorldCountriesGeneralized TypeScript SDK Reference

Complete API reference for the ArcgisHubWorldCountriesGeneralized TypeScript SDK.
...
```ts
new ArcgisHubWorldCountriesGeneralizedSDK(options?: object)
```
...
#### `ArcgisHubWorldCountriesGeneralizedSDK.test(testopts?, sdkopts?)`
...
**Returns:** `ArcgisHubWorldCountriesGeneralizedSDK` instance in test mode.
...
Alias for `ArcgisHubWorldCountriesGeneralizedSDK.test()`.
...
Return the parent `ArcgisHubWorldCountriesGeneralizedSDK` instance.
