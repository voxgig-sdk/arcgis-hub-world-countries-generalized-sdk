// Command ArcgisHubWorldCountriesGeneralized-mcp is an MCP server exposing the ArcgisHubWorldCountriesGeneralized
// SDK as MCP tools.
//
// Two tools are registered:
//
//	ArcgisHubWorldCountriesGeneralized_list  — list records of an entity
//	ArcgisHubWorldCountriesGeneralized_load  — load a single record of an entity
//
