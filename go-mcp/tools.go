...
type Args struct {
	Entity string         `json:"entity" jsonschema:"feature | metadata"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.ArcgisHubWorldCountriesGeneralizedSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "arcgis-hub-world-countries-generalized_list",
		Description: "List records from ArcgisHubWorldCountriesGeneralized. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "arcgis-hub-world-countries-generalized_load",
		Description: "Load a single record from ArcgisHubWorldCountriesGeneralized. " +
...
func runOp(client *sdk.ArcgisHubWorldCountriesGeneralizedSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.ArcgisHubWorldCountriesGeneralizedSDK, name string) (sdk.ArcgisHubWorldCountriesGeneralizedEntity, error) {
